 ...
 */
async function setCredentialsPath(credentialsPathOverride) {
...
function createOAuth2Client() {
    ...
    const oauth2Client = new google.auth.OAuth2(process.env.STD_CLIENT_ID, process.env.STD_CLIENT_SECRET, redirectUri);
